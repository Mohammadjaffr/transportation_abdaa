<div class="container-fluid px-3 pt-4 text-center">
    ...
    <div class="d-grid gap-4">
        <a href="{{ route('driver.attendance', ['type' => 'morning']) }}" class="card shadow-sm text-decoration-none border-0 rounded-4">
            <div class="card-body p-4 border-start border-5 border-primary text-start d-flex align-items-center justify-content-between rounded-4">
                <div>
        ...
        <a href="{{ route('driver.attendance', ['type' => 'leave']) }}" class="card shadow-sm text-decoration-none border-0 rounded-4">
            <div class="card-body p-4 border-start border-5 border-info text-start d-flex align-items-center justify-content-between rounded-4">
                <div>
