<div class="container-fluid px-3 pt-2">
    <!-- Greeting Card -->
    <div class="card bg-primary text-white mb-4 position-relative overflow-hidden shadow-sm"
    ...
    <div class="row g-3 mb-5">
        <div class="col-12">
            <div class="card shadow-sm h-100 p-4 border-0 rounded-4 animate-scale" style="background-color: #ffffff;">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    ...
                    <div class="bg-primary bg-opacity-10 text-primary rounded-circle p-2"><i
        ...
        <div class="col-6">
            <div class="card shadow-sm h-100 p-4 border-0 rounded-4 text-center animate-scale"
    ...
    <div class="d-grid gap-3">
        <a href="{{ route('driver.attendance', ['type' => 'morning']) }}"
            class="btn btn-primary btn-lg rounded-4 shadow-sm py-3 fw-bold d-flex align-items-center justify-content-between px-4">
        ...
        <a href="{{ route('driver.attendance', ['type' => 'leave']) }}"
            class="btn btn-info btn-lg text-white rounded-4 shadow-sm py-3 fw-bold d-flex align-items-center justify-content-between px-4"
            style="background-color: #0dcaf0;">
            <span>بدء تحضير العودة</span>
            <div class="bg-white text-info rounded-circle d-flex align-items-center justify-content-center"
                style="width:36px; height:36px;">
                <i class="fas fa-moon"></i>
            </div>
        </a>
        <a href="{{ route('driver.history') }}"
            class="btn btn-light btn-lg rounded-4 shadow-sm py-3 fw-bold d-flex align-items-center justify-content-between px-4 text-dark border">
