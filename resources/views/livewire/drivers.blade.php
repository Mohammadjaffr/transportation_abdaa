    ...
    <div class="container py-4">
        ...
        'Ownership' => 'الملكية',
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        type="{{ in_array($field, ['IDNo', 'Phone', 'LicenseNo']) ? 'number' : 'text' }}"
                                        wire:model="fields.{{ $field }}"
                                        class="form-control @error('fields.' . $field) is-invalid @enderror"
                                        {{ $field == 'IDNo' && $editMode ? 'disabled' : '' }}>
                                    @error('fields.' . $field)
                            ...
                            <div class="col-md-12 mb-3">
                                <label class="form-label text-primary fw-bold d-block mb-2">
                                    ...
                                    <i class="fas fa-image me-2"></i> صورة السائق
                                </label>
                        ...
                        @forelse($drivers as $driver)
                            <tr class="text-center">
                                ...
                                <td class="text-center">
                                    ...
                                    @if ($student->Picture)
                                        <img src="{{ url($student->Picture) }}" alt="{{ $student->Name }}" class="img-thumbnail"
                                            width="80" height="80">
                                    @else
