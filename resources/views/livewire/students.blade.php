    ...
    <div class="container py-4">
                ...
                <form wire:submit.prevent="{{ $editMode ? 'updateStudent' : 'createStudent' }}">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" wire:model="grade" class="form-control @error('grade') is-invalid @enderror">
                        ...
                        <div class="col-6 mt-3">
                            <button type="submit" class="btn btn-{{ $editMode ? 'primary' : 'success' }} w-100 rounded-pill">
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <button type="button" wire:click="cancel" class="btn btn-outline-secondary w-100 rounded-pill">
        ...
        <div class="col-md-12 mb-3">
            <div class="input-group input-group-lg shadow-sm rounded-pill overflow-hidden">
                ...
                <input type="text" wire:model.debounce.300ms.live="search" class="form-control border-0 py-2" placeholder="ابحث باسم الطالب أو الرقم...">
            </div>
        </div>
                    ...
                    <table class="table table-hover table-striped align-middle mb-0 text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $student->Name }}</td>
                                <td>{{ $student->Grade ?? '-' }}</td>
                                <td>{{ $student->bus?->BusType ? 'الباص نوع : '.$student->bus->BusType : '-' }}</td>
                                <td class="d-flex gap-2 justify-content-center">
                                    <button wire:click="editStudent({{ $student->id }})" class="btn btn-outline-success btn-sm rounded-pill mr-2">
                                        <i class="fas fa-edit"></i> تعديل
                                    </button>
                                    <button wire:click="confirmDelete({{ $student->id }})" class="btn btn-outline-danger btn-sm rounded-pill">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow-sm">
                    ...
                    <div class="modal-footer justify-content-start">
                        <button type="button" class="btn btn-secondary rounded-pill" wire:click="$set('deleteId', null)">إلغاء</button>
                        <button type="button" class="btn btn-danger rounded-pill" wire:click="deleteStudent">نعم، احذف</button>
                    </div>
                </div>
            </div>
        </div>
